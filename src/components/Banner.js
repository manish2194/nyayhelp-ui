...
//   width: 100%;
//   overflow: hidden; // to hide slides that are out of view
//   position: relative;
// `;
...
//   const slides = [
//     {
//       imageUrl: "https://source.unsplash.com/random/1600x900?justice",
//       text: "Justice Served with Integrity",
//       subtext: "Experience the best legal support."
//     },
//     {
//       imageUrl: "https://source.unsplash.com/random/1600x900?legal",
...
//       subtext: "Ensuring justice every step of the way."
//     }
//   ];
...
//           <Slide key={index} style={{ backgroundImage: `url(${slide.imageUrl})` }}>
...
const Carousel = () => {
  ...
  return (
    <SlidesContainer>
      <SlidesWrapper style={{ transform: `translateX(${computedShift})` }}>
        {slides.map((slide, index) => (
          <Slide key={slide.id} style={{ backgroundImage: `url(${slide.imageUrl})` }}>
            <BannerText>{slide.text}</BannerText>
            <BannerSubText>{slide.subtext}</BannerSubText>
          </Slide>
        ))}
